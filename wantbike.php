         ...
         <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <div class="row">
                  ...
                  <!-- /. form  --> 
                  <div class="content">
<!-- <?php echo" <h2>Hello, ".$user1."</h2>"; ?> -->
      <form method="POST" action="bikerlist.php">
      ...
      <option name="Bibwewadi"value="Bibwewadi">Bibwewadi</option>
      <option name="kondhwa" value="kondhwa">Kondhwa</option>
      <option name="Lower_Indiranagar"value="Lower_Indiranagar">Lower Indiranagar</option>
      <option name="Upper_Indiranagar" value="Upper_Indiranagar" >Upper Indiranagar</option>
      <option name="Chintamaninagar1" value="Chintamaninagar1" >Chintamaninagar 1</option>
      <option name="Chintamaninagar2" value="Chintamaninagar2" selected>Chintamaninagar 2</option>

...
<head>
    ...
    <link href="bs-simple-admin/assets/css/utilities.css" rel="stylesheet" />
</head>
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                        <div class="div-square">
                            <a href="./forum/index.php">
                                <i class=" fa fa fa-quora fa-4x" aria-hidden="true"></i>
                                <h5 style='color:black; text-decoration:none;' alt='room mate icon'>Forum</h5>
                            </a>

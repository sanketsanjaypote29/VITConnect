                ...
                <div class="row">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                      <div class="div-square">
                           <a href="shareroom.php" >
                           <i class="fa fa-solid fa-house-user fa-4x"></i>
                      <h5 style='color:black; text-decoration:none;' >Do you want to share room?</h5>
                                </a>
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                      <div class="div-square">
                           <a href="roomfinderlist.php" >
                           <i class="fa fa-solid fa-people-roof fa-4x"></i>
                      <h5 style='color:black; text-decoration:none;'>Do you need room?</h5>
                      </a>
                      </div>
            <!-- /. WRAPPER  -->

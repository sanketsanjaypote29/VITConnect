                ...
                <div class="row text-center pad-top">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        <div class="div-square">
                            <a href="./crud-main/additem.php">
                                <i class=" fa fa-solid fa-book  fa-4x"></i>
                                <h5 style='color:black; text-decoration:none;'>Do you want to Sell a product?</h5>
                            </a>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        <div class="div-square">
                            <a href="./crud-main/buyer_home2.php">
                                <i class="fa fa-solid fa-users fa-4x"></i>
                                <h5 style='color:black; text-decoration:none;'>Do you want to Buy a Product?</h5>
                            </a>
                        </div>
                        <!-- /. WRAPPER  -->
